...
typedef void __cdecl GetMQR(IWICMetadataQueryReader *);

typedef void __cdecl SetCustomProps(IPropertyBag2 *);

typedef void __cdecl EvaluateFunc(_In_reads_(width) const XMVECTOR *pixels, size_t width, size_t y);
